...
#+RESULTS:
: ((APT . +org-todo-active) ((APT . +org-todo-active)) ([-] . +org-todo-active) (STRT . +org-todo-active) ([?] . +org-todo-onhold) (WAIT . +org-todo-onhold) (HOLD . +org-todo-onhold) (PROJ . +org-todo-project) (NO . +org-todo-cancel) (KILL . +org-todo-cancel))
** Folding
#+begin_src emacs-lisp
...
(after! org-roam
  ...
  (setq org-roam-capture-templates
        '(("d" "default" plain "%?"
         ...
         ("i" "Religion")
          ("in" "note" plain "%?"
           :if-new (file+head "Islam/%<%Y%m%d%H%M%S>-${slug}.org"
                              "#title: ${title}\n")
           :unnarrowed t)

          ("ik" "Kuthbah" plain "%?"
           :if-new (file+head) "Islam/Khutba/%<%Y%m%d%H%M%S>-${slug}.org" "#title: ${title}\n#+Date: %(org-read-date nil nil nil)")
          )
